...
const RegisterForm = ({ onBack, onSuccess }) => {
  ...
  return (
    <motion.div className="min-h-screen flex flex-col items-center justify-center bg-background text-text"
      ...
      <h2 className="text-4xl font-heading mb-4">Register</h2>
      <form onSubmit={handleRegister} className="flex flex-col gap-4 w-full max-w-xs bg-surface p-8 rounded-xl shadow-lg">
        <input
          type="text"
        ...
        <motion.button
          type="submit"
          className="mt-2 px-6 py-2 rounded bg-aura text-white font-heading shadow-aura hover:bg-accent transition disabled:opacity-60"
